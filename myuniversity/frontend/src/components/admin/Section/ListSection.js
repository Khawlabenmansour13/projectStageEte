...
export class ListSection extends Component {
    ...
    onDelete = (e, id) => {
        ...
        Swal.fire({
            ...
            text: "You won't be able to return this Section!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                axios.get('http://localhost:8000/section/deleteSection/' + id);
                this.setState({sections: this.state.sections.splice(this.state.identifiant, 1)});
                //GET ALL  Sections
                axios.get('http://localhost:8000/section/getAllsections/').then((res) => {
